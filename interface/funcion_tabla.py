...
def tabla2(df2,self):
    ...
    self.ui.tableWidget_2.setRowCount(nrow)
    self.ui.tableWidget_2.setColumnCount(ncolumn)
    self.ui.tableWidget_2.setHorizontalHeaderLabels(listnameheaders)
    
    for ii in range(0, ncolumn):
        mainins =data[ii]
        for var in range(0, nrow):
            self.ui.tableWidget_2.setItem(var, ii, QtWidgets.QTableWidgetItem((str(mainins[var]))))      